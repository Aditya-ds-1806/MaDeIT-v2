...
<body>
    ...
    <section class="container-fluid position-relative py-5 px-0" id="about">
        <div class="container text-center mt-5 py-5">
            ...
            <a href="people.php" class="btn btn-sea-buckthorn text-white">Know More</a>
        </div>
    ...
    <section class="container-fluid bg-wild-sand text-center py-5" id="portfolio">
        ...
        <div class="container text-center mb-5 pb-5">
            ...
            <a href="portfolio.php" class="btn btn-outline-emperor px-4 pb-2 mt-5">View more</a>
        </div>
    </section>
    ...
    <section class="container-fluid text-center mx-auto py-5 my-5" id="news">
        ...
        <div class="container mb-4">
            ...
            <a href="news.php" class="btn btn-outline-emperor text-center px-4 py-2">View more</a>
        </div>
    </section>
