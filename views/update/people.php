...
<body class="p-2">
        ...
        <form id="form" class="text-left my-5">
            <div class="input-group">
                <div class="custom-file">
                    ...
                    <label id="fileName" class="custom-file-label" for="inputGroupFile02" aria-describedby="inputGroupFileAddon02">Upload image of person</label>
                </div>
    ...
    <script>
        $("#form").on('submit', function(e) {
            ...
            formData.append("target-dir", "/images/people/");
            $.ajax({
                type: "POST",
