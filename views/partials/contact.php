...
<section class="container-fluid bg-sea-buckthorn text-white">
    <div class="container py-5">
        <div class="row justify-content-between p-lg-5 px-xl-4">
            <div class="col-sm-5 col-lg-3 text-center text-sm-left mt-5 mt-sm-0">
                <h6>SUBSCRIBE</h6>
            ...
            <div class="col-sm-7 col-lg-4 col-xl-3 text-center text-sm-right text-lg-left my-5 my-lg-0">
                ...
                <span class="d-block">Melakottaiyur Village,</span>
        ...
        <hr class="bg-white">
        <span>&copy; IIITDM Kancheepuram 2020</span>
    </div>
</section>