...
<body class="p-2">
        ...
        <form id="form" class="text-left my-5">
            <div class="input-group">
                <div class="custom-file">
                    <input type="file" class="custom-file-input" accept=".pdf" name="file" id="inputGroupFile02" onchange="$(this).next('.custom-file-label').html($(this).val()); $('#name').val($(this).val())" required>
                    <label id="fileName" class="custom-file-label" for="inputGroupFile02" aria-describedby="inputGroupFileAddon02">Upload Tender document</label>
                </div>
    ...
    <script>
        $("#form").on('submit', function(e) {
            ...
            formData.append("target-dir", "/tenders/");
            $.ajax({
                type: "POST",
